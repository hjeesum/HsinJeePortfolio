  ...
  return (
    <div className="mt-20 mb-20">
      <div className="flex items-center gap-2 mt-3 cursor-pointer group/contact">
        <span className="group-hover/contact:text-yellow-400">hsinjeesum@gmail.com</span>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
          fill="currentColor"
          className="h-6 w-6 group-hover/contact:-translate-y-0.5 group-hover/contact:translate-x-0.5 duration-200 transition-transform group-hover/contact:text-yellow-400"
          aria-hidden="true"
        >
      ...
      <div className="flex items-center gap-2 mt-3 cursor-pointer group/contact">
        <span className="group-hover/contact:text-yellow-400">+44 7858-325-831</span>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
          fill="currentColor"
